                ...
                child: IntrinsicHeight(
                  child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(imagePath, width: 250, height: 154, alignment: Alignment.topCenter),
                        Column(
                          children: [
                            Text(
                        ...
                        ElevatedButton(
                          onPressed: provider.isLoading ? null : () {
                            ...
                            provider.createLogin(_loginController.text, _passwordController.text, _confirmPasswordController.text);
                          }, 
                          ...
                          child: provider.isLoading ? CircularProgressIndicator()
                          : Text(
