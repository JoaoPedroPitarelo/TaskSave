...
import 'package:app/presentation/screens/register/confirm_email_screen.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (registerViewmodel.userCreated) {
    ...
    if (registerViewmodel.error != null) {
      WidgetsBinding.instance.addPostFrameCallback( (_) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              registerViewmodel.error.toString(),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: registerViewmodel.isLoading ? null : () {
                        ...
                        registerViewmodel.createLogin(_loginController.text, _passwordController.text, _confirmPasswordController.text);
                      },
